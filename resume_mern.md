...
- **MERN Stack Core:** React.js (Hooks, Context API, Redux), Node.js, Express.js
...
- Enhanced client's discussion board with performance improvements, new features, and maintenance on Node.js/Express.js backend.  
...
[**Real-world API (Node.js/Express.js)**](https://github.com/segmentationfaulter/realworld_api)  
- Implemented "RealWorld" backend API specification using **Node.js and Express.js** with PostgreSQL database  
- Designed RESTful APIs with JWT authentication, proper database modeling, and error handling  
- Containerized application and database with Docker and Docker Compose for consistent environments  
- Followed industry best practices for API design and documentation  
